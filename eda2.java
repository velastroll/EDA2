...
public class eda2{
    ...
    public void add (int [] vector, int clave, ArrayList<int[]> almacen_vector, ArrayList<Object> almacen_claves){
        if (almacen_vector.isEmpty()){
            almacen_vector.add(vector);
            almacen_claves.add(clave);
        } else {
            int posicion_almacen = search2add(vector, almacen_vector, almacen_claves);
            almacen_vector.add(posicion_almacen, vector);
            almacen_claves.add(posicion_almacen, clave);
        }
    }

    public int search2add(int [] vector2add, ArrayList<int[]> almacen_vector, ArrayList<Object> almacen_claves){
        ...
        if (inicio == fin){
            ...
            return search2add(vector2add, almacen_vector, almacen_claves);
        }
    }
